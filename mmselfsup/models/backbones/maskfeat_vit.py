...
class MaskFeatViT(VisionTransformer):
    ...
    A PyTorch implement of: `Masked Feature Prediction for Self-
    Supervised Visual Pre-Training <https://arxiv.org/abs/2112.09133>`_
    ...
    def init_weights(self):
        super(MaskFeatViT, self).init_weights()
